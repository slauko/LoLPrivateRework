...
int main()
{
	...
	char DllName[] = "LoLPrivateRework.dll";
	char GameName[] = "League of Legends.exe";


	printf("\nOpening the DLL.\n");
	hFile = CreateFile(DllName, GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL); // Open the DLL
	...
	ProcessId = FindProcessId(GameName);
